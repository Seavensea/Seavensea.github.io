...
$.ajax({
  ...
  data: {
    key: 'ISXBZ-J6UWQ-MWX5U-4NSTC-473BO-VHBW3',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function createtime1() {
  ...
  var ascll = [
    `欢迎来到Seavenseaのtiny home!`,
    `Future is now 🍭🍭🍭`,
    `
        
    ______ ____ _____ ___  __ ____   ____   ______ ____ _____   
    /  ___// __ \\__  \\  \/ // __ \ /    \ /  ___// __ \\__  \  
    \___ \\  ___/ / __ \\   /\  ___/|   |  \\___ \\  ___/ / __ \_
   /____  >\___  >____  /\_/  \___  >___|  /____  >\___  >____  /
        \/     \/     \/          \/     \/     \/     \/     \/
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Seavensea %c 你正在访问Seavenseaのtiny home",
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("07/11/2023 00:00:00");
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      // ? `<img class='boardsign' src='/assets/lemon.svg' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      // : `<img class='boardsign' src='/assets/lemon.svg' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://cdn.jsdelivr.net/gh/Seavensea/blog_picgo@main/2023/7/1317738.png);
    --darkmode-bg:url(https://cdn.jsdelivr.net/gh/Seavensea/blog_picgo@main/2023/7/1318421.png);
